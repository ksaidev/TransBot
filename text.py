...
registrationReq = 'TransBot을 사용하시려면 \'/등록\'을 입력해 주세요.\n' \
...
engHelpMsg = '/auto, /a\n' \
             ...
             'In Manual mode, you can translate messages manually by replying \'/translate\' or \'/tr\' to the message that you want to language.'

alreadyAuto = '자동 모드는 이미 활성화되어 있습니다.\n' \
              'Auto mode is already active.'
changeToAuto = '이제부터 모든 메시지가 자동으로 변역됩니다.\n' \
               'All messages will be translated automatically from now on.'
alreadyManual = '수동 모드는 이미 활성화되어 있습니다.\n' \
                'Manual mode is already active.'
changeToManual = '이제 메시지가 자동으로 번역되지 않습니다.\n' \
                 'All messages will not be translated automatically from now on.'

syncStart = '동기화 중...\n' \
            'Synchronizing...'

ManualSelectionError = '번역할 메시지를 선택해 주세요.\n' \
